...
const pageGuides = [
  ...
  {
    title: "Classes",
    description: "Manage weekly batches, extra classes, and class fee setup.",
  },
  {
    title: "Attendance",
    ...
    <div className="page-stack">
      <PageHeader
        ...
        actions={
          <div className="help-chip-row">
            ...
            <span className="info-chip">Classes + theme</span>
          </div>
        }
      />
      ...
      >
        <div className="help-list">
          ...
          <div className="help-list-item">
            3. Set up classes first, then use the attendance page to scan a student QR code or add attendance manually.
          </div>
        </div>
      </SectionCard>
      ...
      >
        <div className="help-list">
          ...
          <div className="help-list-item">Review or update class schedules before a new month starts.</div>
